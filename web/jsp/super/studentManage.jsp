        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.getContextPath()}/user/getAllStudent" class="active">
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                            <c:forEach var="work" items="${allStudent}">
...
<%--    <a href="#" onClick="javascript:windowOpen('/user/toUpdate?wid=${work.wid}','','',500,420,'no','yes','100','100')">修改</a> |--%>
                                        <a href="${pageContext.request.contextPath}/user/toUpdateStu?sid=${work.sid}" data-toggle="modal" data-target="#xiugai">更改</a> |
                                        <a href="${pageContext.request.contextPath}/user/deleteStu?sid=${work.sid}">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="/user/addStudent">
                    <p class="text-danger"></p>
                    <div class="myform-group">
                        <label class="control-label">学号:</label>
                        <input name="sid" required="required" type="text" class="form-control" placeholder="请输入" >
                    </div>
                    <div class="myform-group">
                        <label  class="control-label">姓名:</label>
                        <input name="sname" required="required" type="text" class="form-control" placeholder="请输入" >
                    </div>
                    <div class="myform-group">
                        <label  class="control-label">联系方式:</label>
                        <input name="sphone" required="required" type="text" class="form-control" placeholder="请输入" >
                    </div>
                    <div class="myform-group">
