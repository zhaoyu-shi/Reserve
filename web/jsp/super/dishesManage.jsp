        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.getContextPath()}/user/getAllWorker">
                            <i class="fa fa-fw fa-address-card-o" style="font-size:16px"></i> 查看窗口
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.getContextPath()}/user/getAllStudent">
                            <i class="fa fa-edit fa-fw" style="font-size:18px"></i> 查看学生
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.getContextPath()}/user/getAllDishes" class="active">
                            <i class="fa fa-thumbs-o-up fa-fw" style="font-size:16px"></i> 查看订单
                        </a>
                    </li>
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                            <c:forEach var="work" items="${allOrder}">
                                <tr class="text-center">
                                    ...
                                    <td>${work.price}</td>
                                    <td>
                           <%--             <a href="${pageContext.request.contextPath}/user/toUpdateDishes?did=${work.did}">更改</a> |--%>
<%--    <a href="#" onClick="javascript:windowOpen('/user/toUpdate?wid=${work.wid}','','',500,420,'no','yes','100','100')">修改</a> |--%>
                                        <a href="${pageContext.request.contextPath}/user/toUpdateDishes?did=${work.did}" data-toggle="modal" data-target="#xiugai">更改</a> |
                                        <a href="${pageContext.request.contextPath}/user/deleteDishes?did=${work.did}">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1">管理员密码</h4>
            </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="/user/addDishes">
                    <p class="text-danger"></p>
                    <div class="myform-group">
                        <label class="control-label">买家学号:</label>
                        <input name="suid" required="required" type="text" class="form-control" placeholder="请输入" >
                    </div>
                    <div class="myform-group">
                        <label  class="control-label">餐品:</label>
                        <input name="dname" required="required" type="text" class="form-control" placeholder="请输入" >
                    </div>
                    <div class="myform-group">
                        <label  class="control-label">窗口:</label>
                        <input name="wuid" required="required" type="text" class="form-control" placeholder="请输入">
                    </div>
                    <div class="myform-group">
                        <label  class="control-label">数量:</label>
                        <input name="num" required="required" type="text" class="form-control" placeholder="请输入">
                    </div>
                    <div class="myform-group">
                        <label  class="control-label">价格:</label>
                        <input name="price" required="required" type="text" class="form-control" placeholder="请输入">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
